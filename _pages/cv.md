...
Significant works
------
* [**Brown, R.**, Haumann, A., Losch, M., Rauch, C., & Janout, M. (2025, September 16--18). *Shallow offshore convective plumes as a mechanism for water mass transformations in the Southern Ocean* [Poster presentation]. CELLO Conference 2025, Hamburg, Germany](https://rowanjb.github.io/works/202509_CELLO_poster/) [Link to the abstract](https://cello-conference.de/frontend/index.php?page_id=49511&additions_conferenceschedule_action=detail&additions_conferenceschedule_controller=paperList&pid=139972&hash=2b49a88276c3bfee2704f242187aac90adaa295074ab08c7936d1e07645ca616)
* [**Brown, R.**, Haumann, A., Losch, M., Rauch, C., & Janout, M. (2025, April 27--May 2). *Shallow open-ocean convection in the Weddell Sea: A case study using observations and modelling techniques* [Poster presentation]. EGU General Assembly 2025, Vienna, Austria](https://rowanjb.github.io/works/202505_egu25_poster/) [https://doi.org/10.5194/egusphere-egu25-6934](https://doi.org/10.5194/egusphere-egu25-6934)
...
* Jul 2022--Jun 2024: **Graduate research assistant fellowship**\\
  **University of Alberta**, Canada
  * Reduced climate biases in the Labrador Sea mixed layer depth by up to 82% using tides and a parameterisation for unresolved mixed layer eddies
  * Conducted tidal analyses of a high-resolution NEMO model as operational support for Fisheries and Oceans Canada

* Oct 2021--Feb 2022: **Ocean engineer**\\
  **Oceans Limited**, Canada
  * Recruited to resolve a critical fault with vessel motions analysis software, ensuring uninterrupted service to clients in offshore industry
  * Researched new methods of wave spectra prediction using machine learning
...
* May 2018--Aug 2018: **Research assistant in human factors engineering**\\
  ...
  * Analysed experimental human-factors data
  * Designed experimental scenarios for a maritime simulator
...
------
* **Cruise activities**: CTD, salinometer, and ice station operations during PS153 “Summer Weddell Outflow Study” aboard RV Polarstern (Feb 3–Apr 9, 2026); CTD instructor during North Sea training cruise aboard RV Heincke (Mar 28–Apr 2, 2025)
...
* **Memberships**: The Canadian Meteorological and Oceanographic Society ([CMOS](https://www.cmos.ca)); The Society of Naval Architects and Marine Engineers ([SNAME](https://www.sname.org)); The European Geosciences Union (EGU)
...
* Modelling skills, i.e., 
  * Setting up and running models like MITgcm on HPCs and supercomputers
